...
public class ChangePasswordActivity extends AppCompatActivity
    ...
    private EditText oldEmail, oldPassword, newPassword, reEnterPassword;
    private Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newPassword = (EditText) findViewById(R.id.editNewPass);
        reEnterPassword = (EditText) findViewById(R.id.editRePass);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    ...
                    final String _newPass = newPassword.getText().toString().trim();
    ...
    public boolean validate() {
        ...
        String _newPass = newPassword.getText().toString().trim();
        String _reEnterPassword = reEnterPassword.getText().toString().trim();
        ...
        if (_newPass.isEmpty() || _newPass.length() < 6) {
        ...
        if (_reEnterPassword.isEmpty() || (!_reEnterPassword.equals(_newPass))) {
